...
def sample_trajectories(env, policy, min_timesteps_per_batch, max_path_length, render=False, render_mode=('rgb_array')):
    ...
    while timesteps_this_batch < min_timesteps_per_batch:
        ...
        cur_path = sample_trajectory(env, policy, max_path_length, render=render, render_mode=render_mode)
...
def sample_n_trajectories(env, policy, ntraj, max_path_length, render=False, render_mode=('rgb_array')):
    ...
    for _ in range(ntraj):
        paths.append(sample_trajectory(env, policy, ntraj, max_path_length, render=render, render_mode=render_mode))
    return paths
...
def convert_listofrollouts(paths):
    ...
    return observations, actions, next_observations, concatenated_rewards, unconcatenated_rewards
    #return observations, actions, next_observations, concatenated_rewards
